...
previous_version:
reason: Define observable privacy-preserving account recovery behavior from approved IDEA-009
source_versions:
  IDEA-009: 2
assumptions:
