...
COPY . .
RUN SECRET_KEY_BASE_DUMMY=1 REQUIRE_MASTER_KEY=false APP_HOST=localhost DATABASE_HOST=localhost DATABASE_USERNAME=postgres DATABASE_PASSWORD=postgres DATABASE_NAME=bootcamper_build RAILS_ENV=production bin/rails tailwindcss:build
EXPOSE 3000
